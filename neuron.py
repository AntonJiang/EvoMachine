...
class Neuron:
    ...
    def update_input_neurons(self, neurons):
        self.input_neurons = np.hstack((self.input_neurons, neurons))
    ...
    def produce(self, meta_neurons):
        ...
        new_neuron = Neuron(self.distance, self.activation, new_connection, self.meta_variant,
    ...
    def update(self, meta_neurons):
        ...
        self.meta_variant = rng.normal(self.meta_variant, self.meta_variant / 3)
